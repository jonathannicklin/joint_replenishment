...
int main() {
    ...
    //Get path to IO_DynaPlex/mdp_config_examples/joint_replenishment_mdp/mdp_config_name:
    ...
    DynaPlex::VarGroup nn_architecture{
            {"type","mlp"},
            {"hidden_layers",DynaPlex::VarGroup::Int64Vec{128,128,128}}
    };
    int64_t num_gens = 5;
    ...
    try {
        ...
        comparerConfig.Add("periods_per_trajectory", 1000);
        ...
        //auto path = dp.System().filepath("dcl", "joint_replenishment", "joint_replenishment_policy_gen" + num_gens);
